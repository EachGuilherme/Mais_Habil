...
class TodosOsChatsWidget extends StatefulWidget {
  const TodosOsChatsWidget({super.key});

  static String routeName = 'todosOsChats';
  static String routePath = '/todosOsChats';

  @override
  State<TodosOsChatsWidget> createState() => _TodosOsChatsWidgetState();
}
